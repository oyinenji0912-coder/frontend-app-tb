  ...
  return <div className="portal-page">
    ...
    <main className="portal-main">
      ...
      <section className="portal-grid" aria-label="Daftar layanan">
        <a className="portal-card portal-card-active" href="/tb"><img className="portal-card-image" src="/kawal-tb/portal-pengobatan.webp" alt="" aria-hidden="true" loading="lazy" /><span className="portal-card-content"><span className="portal-card-number">01</span><span className="portal-card-title">Dalam Pengobatan</span><span className="portal-card-action">Buka database <span aria-hidden="true">→</span></span></span></a>
        <a className="portal-card portal-card-active portal-card-tracing" href="/tracing"><img className="portal-card-image" src="/kawal-tb/portal-tracing.webp" alt="" aria-hidden="true" loading="lazy" /><span className="portal-card-content"><span className="portal-card-number">02</span><span className="portal-card-title">Jadwal dan Rekap Tracing TB</span><span className="portal-card-action">Buka database <span aria-hidden="true">→</span></span></span></a>
        <a className="portal-card portal-card-active portal-card-queue" href="/poli-tb"><img className="portal-card-image" src="/kawal-tb/portal-pendaftaran.webp" alt="" aria-hidden="true" loading="lazy" /><span className="portal-card-content"><span className="portal-card-number">03</span><span className="portal-card-title">Pendaftaran Poli TB</span><span className="portal-card-action">Kelola antrean <span aria-hidden="true">→</span></span></span></a>
        <a className="portal-card portal-card-active portal-card-sputum" href="/dahak"><img className="portal-card-image" src="/kawal-tb/portal-dahak.webp" alt="" aria-hidden="true" loading="lazy" /><span className="portal-card-content"><span className="portal-card-number">04</span><span className="portal-card-title">Rekapitulasi Pemeriksaan Dahak</span><span className="portal-card-action">Buka rekap dan grafik <span aria-hidden="true">→</span></span></span></a>
      </section>
